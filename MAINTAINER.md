...
Quick reference for maintaining the Lattice Registry repository.
...
📦 lattice/agent-identity: v1.0.0 (needs tag)
✅ lattice/policy-engine: v1.0.0 (already tagged)

## Tags to be created:
- `release/lattice/agent-identity/v1.0.0`
...
Changes are automatically published to [registry.latticeruntime.com](https://registry.latticeruntime.com) after tags are pushed.
